...
import com.example.moneymanager.viewmodels.IncomeAnalyticPageViewModel
import com.example.moneymanager.viewmodels.viewModelFactory
import java.text.DecimalFormat

@Composable
fun IncomeAnalyticPage(
	innerPadding: PaddingValues,
	page: Int,
	recurrence: Recurrence,
	incomes: List<IncomeResponse>,
	categories: List<CategoryResponse>,
	incomeAnalyticPageViewModel: IncomeAnalyticPageViewModel = viewModel(
		key = "$page-${recurrence.name} ",
		factory = viewModelFactory {
			IncomeAnalyticPageViewModel(
				page = page,
				recurrence = recurrence,
				incomes = incomes,
	...
	val uiState by incomeAnalyticPageViewModel.uiState.collectAsState()
	...
	Column(
		...
		Box(
			...
			when (recurrence) {
				Recurrence.Weekly -> WeeklyChart(expenses = null, incomes = uiState.filteredIncomes)
				Recurrence.Monthly ->
					MonthlyChart(
						expenses = null,
				...
				Recurrence.Yearly -> YearlyChart(expenses = null, incomes = uiState.filteredIncomes)
				else -> Unit
			}
		}
